      ...
      //for(vector<int>::iterator it=l1.begin();it!=l1.end();it++)
       ...
       for(vector<pair<int,int> >::iterator it=final_schedule.begin();it!=final_schedule.end();it++){
        ...
        for(int num_ch=2;num_ch<=4;num_ch++){
                ...
                cout<<" "<<valve_used(myvec_storage,temp_list);
                myvec_storage.clear();
    ...
    for(int a=2;a<=10;a++){
         for(int b=1;b<=5;b++){
             for(int c=0;c<=5;c++){
                  ...
                  string str2="N"+to_string(a)+"/n"+to_string(a)+"_d"+to_string(b)+"/scheduling2_d"+to_string(b)+"_n"+to_string(a)+"_"+to_string(file_arr[c])+".txt";
                  //freopen("N5/n5_d4/Test_d4_n5_2.txt","r",stdin);
                  //freopen("N5/n5_d4/Result_d4_n5_2.txt","w",stdout);
                  int total=0;
...
int main(){
  ...
  //  freopen(str1.c_str(),"r",stdin);
  //  freopen(str2.c_str(),"w",stdout);
    freopen("test_result1.txt","a",stdout);
    int n;
    //cin>>n>>accuracy>>segment;
    n=1,accuracy=4,segment=8;
    for(int i=0;i<n;i++){
      int m;
      cin>>m;
      total+=m;

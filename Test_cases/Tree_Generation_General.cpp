...
struct tree *  tree_generation(){
 ...
 // cout<<"\n Parent node is created";
  ...
  var=target * 1e9;
  if(var%10==9)  //for removing error while multipling target with 1e9
    var+=1;
...
int main(){
    ...
    for(int a=2;a<=2;a++){ // This is to iterate over testcase folder
         for(int b=8;b<=8;b++){ //this is to iterate over testcase files with number of targets
             for(int c=5;c<=5;c++){
                  ...
                  freopen("N2/n2_d10/Test_d8_n2_5.txt","r",stdin);
                  freopen("N2/n2_d10/Result_d8_n2_5.txt","w",stdout);
                  int total=0;

...
set xrange [-1:6]
set yrange [0:18]
set xtics ("2" 0,"5" 1,"10" 2,"20" 3,"50" 4,"100" 5) font ",14"
set ytics 1 font ",16"
...
plot 'result_n2_d8_bcs.txt' u 2 title "MTSE" lc rgb "red" lw 1,'result_n2_d8_bcs.txt' u 6 title "MTDA" lc rgb "0xFF8C00" lw 1